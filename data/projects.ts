...
export const projects: Project[] = [
  ...
  {
    title: "Stardew Valley Inspired Portfolio",
    description: "A personal portfolio inspired by the cozy visuals and playful spirit of Stardew Valley.",
    image: "/assets/projects/Stardew%20valley.png",
    logo: null,
    technologies: ["Next.js", "React", "Tailwind CSS", "PostCSS"],
    role: "Solo Developer",
    github: "",
    liveDemo: "https://jelaysportfolio.vercel.app/",
    featured: false,
  },
  {
    title: "dainty-scrapbook portfolio",
    description: "A personal portfolio with a dainty scrapbook-inspired visual style and thoughtful interactive details.",
    image: "/assets/projects/Scrapbook%20portfolio.png",
    logo: null,
    technologies: ["Next.js", "React", "Tailwind CSS", "PostCSS"],
    role: "Solo Developer",
    github: "",
